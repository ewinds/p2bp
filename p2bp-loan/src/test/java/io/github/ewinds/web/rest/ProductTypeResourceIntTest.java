...
public class ProductTypeResourceIntTest {
    ...
    private static final BlockType DEFAULT_BLOCK_TYPE = BlockType.DEFAULT;
    private static final BlockType UPDATED_BLOCK_TYPE = BlockType.NOVICE;
    ...
    public void createProductType() throws Exception {
        ...
        assertThat(testProductType.getBlockType()).isEqualTo(DEFAULT_BLOCK_TYPE);
        assertThat(testProductType.getImageUrl()).isEqualTo(DEFAULT_IMAGE_URL);
        assertThat(testProductType.getMobileImageUrl()).isEqualTo(DEFAULT_MOBILE_IMAGE_URL);
        assertThat(testProductType.isDelFlag()).isEqualTo(DEFAULT_DEL_FLAG);
        assertThat(testProductType.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testProductType.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testProductType.getLastModifiedBy()).isEqualTo(DEFAULT_LAST_MODIFIED_BY);
        assertThat(testProductType.getLastModifiedDate()).isEqualTo(DEFAULT_LAST_MODIFIED_DATE);
    }
    ...
    public void getAllProductTypes() throws Exception {
        ...
        restProductTypeMockMvc.perform(get("/api/product-types?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].mobileImageUrl").value(hasItem(DEFAULT_MOBILE_IMAGE_URL.toString())))
    ...
    public void getProductType() throws Exception {
        ...
        restProductTypeMockMvc.perform(get("/api/product-types/{id}", productType.getId()))
            ...
            .andExpect(jsonPath("$.mobileImageUrl").value(DEFAULT_MOBILE_IMAGE_URL.toString()))
    ...
    public void updateProductType() throws Exception {
        ...
        assertThat(testProductType.getBlockType()).isEqualTo(UPDATED_BLOCK_TYPE);
        assertThat(testProductType.getImageUrl()).isEqualTo(UPDATED_IMAGE_URL);
        assertThat(testProductType.getMobileImageUrl()).isEqualTo(UPDATED_MOBILE_IMAGE_URL);
        assertThat(testProductType.isDelFlag()).isEqualTo(UPDATED_DEL_FLAG);
        assertThat(testProductType.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testProductType.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testProductType.getLastModifiedBy()).isEqualTo(UPDATED_LAST_MODIFIED_BY);
        assertThat(testProductType.getLastModifiedDate()).isEqualTo(UPDATED_LAST_MODIFIED_DATE);
    }
