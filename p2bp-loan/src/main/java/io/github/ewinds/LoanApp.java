...
import io.github.ewinds.client.OAuth2InterceptedFeignConfiguration;
...
public class LoanApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(LoanApp.class);

    private final Environment env;

    public LoanApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LoanApp.class);
